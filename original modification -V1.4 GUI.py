...
def date_piker_fun():
    ...
    def grad_date():
        #global dt
        #dt = cal.get_date().strftime("%d-%B-%Y")
...
#Object creation
#Section-0
T_Box0 = InputBox(125+35,15,220,30)#x,y,w,h
T_Box1 = InputBox(155+10,55-5,40,30)

#T_Box2 = InputBox(530,38,150,30) #date entry box


#section-1
save_img = pygame.transform.scale(pygame.image.load('save_img.png'),(50,25))
save_button = P_Button(650,600, save_img, 1)#x,y,image,scale
#date button
date_img = pygame.image.load('date_img.png')
date_button = P_Button(530+70,30-2, date_img, 1)#x,y,image,scale

delete_img = pygame.transform.scale(pygame.image.load('delete_img.png'),(50,25))
#delete_button = P_Button(650,640, delete_img, 1)

news_img = pygame.transform.scale(pygame.image.load('news_img.png'),(80,40))
info_button = P_Button(650,680, news_img, 1)

#Section-3
T_Box3 = InputBox(45+29,453-13,97,60)
#section-4
T_Box4 = InputBox(310-98,545-5,50,30)
#Section-6
T_Box5 = InputBox(585-30,295-50,190,70)
#Section-7  
T_Box6 = InputBox(460-12,440-85,320,130)
#sEction-8 
...
#section-1
sec1_boxes=[]
sec1_button = Checkbox(screen, 190-25, 130-20, 0, caption='')
#sec1_button2 = Checkbox(screen, 360,130, 1, caption='')
sec1_boxes.append(sec1_button)
#sec1_boxes.append(sec1_button2)
#section - 2
sec2_boxes=[]
sec2_button = Checkbox(screen, 120,245-15, 0, caption='')
sec2_button2 = Checkbox(screen, 270-20,245-15, 1, caption='')
sec2_button3 = Checkbox(screen, 385-35,245-15, 2, caption='')
sec2_boxes.append(sec2_button)
sec2_boxes.append(sec2_button2)
sec2_boxes.append(sec2_button3)
#section - 3
sec3_boxes=[]
sec3_button = Checkbox(screen, 75,345-5, 0, caption='')
sec3_button2 = Checkbox(screen, 250,360, 1, caption='')
sec3_button3 = Checkbox(screen, 400-30,360, 2, caption='')
sec3_boxes.append(sec3_button)
sec3_boxes.append(sec3_button2)
sec3_boxes.append(sec3_button3)
#section - 6
sec6_boxes=[]
sec6_button = Checkbox(screen, 525,145-5, 0, caption='')
sec6_button2 = Checkbox(screen, 670+50,145-5, 1, caption='')
sec6_boxes.append(sec6_button)
sec6_boxes.append(sec6_button2)
#section - 7
sec7_boxes=[]
sec7_button = Checkbox(screen, 505+4,270-6, 0, caption='')
sec7_button2 = Checkbox(screen, 750-110,265-45, 1, caption='')
...
while run:
    ...
    *date - new type of no box(show a sample to enter date, few selected symbols which support excel)
    ...
    #btn3 - date
    if pos[0]>date_button.x and pos[0]<date_button.x+date_button.width:
        if pos[1]>date_button.y and pos[1]<date_button.y+date_button.height:
            date_button.image = pygame.transform.scale(pygame.image.load('date_img.png'),(81*1.2,34*1.2))
            #self.scale+2.3
            #self.image = pygame.transform.scale(self.btn_img, (int(self.width * self.scale), int(self.height * self.scale)))
    else:
        date_button.image = pygame.image.load('date_img.png')
    ...
    if date_pick == True:
        #pass
        date_piker_fun()
        root.mainloop() #run the tk inter date picker gui
        date_pick = False
    '''
